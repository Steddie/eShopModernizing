...
namespace eShopLegacyWebForms.Models.Infrastructure
{
    public class CatalogDBInitializer : CreateDatabaseIfNotExists<CatalogDBContext>
    {
        ...
        public CatalogDBInitializer(CatalogItemHiLoGenerator indexGenerator, IConfiguration config, IWebHostEnvironment hostingEnvironment)
        {
            this.indexGenerator = indexGenerator;
            useCustomizationData = config.GetValue<bool>("UseCustomizationData", false);
